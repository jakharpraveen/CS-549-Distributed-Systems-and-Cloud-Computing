...
public class NodeResource {
	...
	@PUT
	@Produces("application/json")
	public Response addBinding(@QueryParam("key") String key, @QueryParam("value") String value) throws Invalid {
		return new NodeService(headers, uriInfo).addBinding(key, value);
	}

	@DELETE
	@Produces("application/json")
	public Response deleteBinding(@QueryParam("key") String key, @QueryParam("value") String value) throws Invalid {
	...
	@Path("finger")
	@Produces("application/json")
	public Response getClosestPrecedingFinger(@QueryParam("id") String id) {
		return new NodeService(headers, uriInfo).getClosestPrecedingFinger(Integer.parseInt(id));
	}
