...
public class PageRankDriver {
										...
										// data to composite
		{
			...
			System.err
					.println("Incorrect Usage \n Correct format: <function name><input><output><#reducers> \n Or \n <function name><input><output><diff><#reducers>"
							+ "\n Or \n <function name><input-links><input-page-names><output><interim1><interim2><diff><#reducers>");
		}
	}
	...
	static void init(String input, String output, int reducers)
		...
		// job.addCacheFile(new URI ("input/simple_link.txt"));
	...
	public static void composite(String input, String pageInput, String output, String interim1,
			String interim2, String diff, int reducers) throws Exception {
		/*
		 * TODO Put your name here
		 */
		System.out.println("Praveen Jakhar(10477184)");
						...
						// is the input directory
		{
			...
			join(interim2, pageInput, "join_output", reducers);
			finish("join_output", output, reducers);
		...
		else // for even i, interim1 is the input directory
		{
			...
			join(interim1, pageInput, "join_output", reducers);
			finish("join_output", output, reducers);
			summarizeResult(output);
		}
		System.out.println();
